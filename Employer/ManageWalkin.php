        ...
        <div id="content">
            ...
            <div class="article">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Управление собеседованием</strong></td>
                  </tr>
                  <tr>
                    <td><form id="form1" method="post" action="InsertWalkin.php">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td><strong>Дата интервью:</strong></td>
                        ...
                        <tr>
                          <td><strong>Время интервью:</strong></td>
                  ...
                  <tr>
                    <td><table width="80%" border="1" bordercolor="#1CB5F1" >
                      <tr>
                        <th height="20" bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Id</strong></div></th>
                        <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Должность</strong></div></th>
                        <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Вакансия</strong></div></th>
                         <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Квалификация</strong></div></th>
                          <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Описание</strong></div></th>
                        <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Дата</strong></div></th>
                        <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Время</strong></div></th>
                        <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style12">Удалить</div></th>
                      </tr>
                      <?php
...
?>
                      <tr>
                        ...
                        <td class="style3"><div align="left" class="style9 style5"><strong><a href="DeleteWalkin.php?WalkinId=<?php echo $Id;?>">Удалить</a></strong></div></td>
                      </tr>
                      <?php
}
...
?>
                      <tr>
                        <td colspan="8" class="style3"><div align="left" class="style12"><?php echo "Всего ".$records." Записей"; ?> </div></td>
                      </tr>
                      <?php
