            ...
            <div class="article">
                ...
                <form id="form1" method="post" action="Application.php">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><strong>Выбрать должность:</strong></td>
                      <td><label>
...
?>
                      ...
                      <td><label>
                        <input type="submit" name="button" id="button" value="Просмотр" />
                      </label></td>
                    </tr>
                  </table>
              </form>
		   ...
		   ?>
                <table width="100%" border="1" bordercolor="#1CB5F1" >
                  <tr>
                    ...
                    <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Имя</strong></div></th>
                    <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Город</strong></div></th>
                    <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Email</strong></div></th>
                    <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Статус</strong></div></th>
                     <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Просмотр & Отправка</strong></div></th>
                  </tr>
                  <?php
...
?>
                  <tr>
                    ...
                    <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $Status;?></strong></div></td>
                     <td class="style3"><div align="left" class="style9 style5"><strong></strong><a href="ViewBiodata.php?JobSeekId=<?php echo $JobSeekId; ?>&AppId=<?php echo $Id;?>&JobId=<?php echo $Title;?>&Status=<?php echo $Status;?>">Рассмотреть</a></div></td>
                  </tr>
                  <?php
}
