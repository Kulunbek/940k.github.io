...
?>
<?php $con=mysqli_connect("localhost","kulunbek","Mitryaev111000","job");?>
<?php
...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Поиск работы</a></span></h2>
               

                <form id="form1" method="post" action="SearchJob.php">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><strong>Выбрать квалификацию:</strong></td>
                      <td><label>
...
?>
                    ...
                    <tr>
                      <td><strong>Выбрать компанию:</strong></td>
                      <td><label>
...
?>
                    ...
                    <tr>
                      <td><strong>Выбрать область работы:</strong></td>
                      <td><label>
...
?>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td><input type="submit" name="button" id="button" value="Поиск" /></td>
                      <td>&nbsp;</td>
                    </tr>
                  </table>
              </form>
                    ...
                    <td width="100%">&nbsp;
						...
						do { ?>
                          ...
                          <td><strong><?php echo $row_Recordset2['Description']; ?></strong></td>
                           ...
                           <tr>
                             <td>&nbsp;</td>
                             <td><a href="Apply.php?JobId=<?php echo $row_Recordset2['JobId'];?>"><strong>Подать заявку</strong></a></td>
                           </tr>
                        </table>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Статус работы</strong></td>
                  </tr>
                  <tr>
                    <td><table width="100%" border="1" cellpadding="1" cellspacing="2" bordercolor="#006699" >
                      <tr>
                        <th height="20" bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Компания</strong></div></th>
                        <th bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Должность</strong></div></th>
                        <th bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Статус</strong></div></th>
                         <th bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Описание</strong></div></th>
                      </tr>
                      <?php
