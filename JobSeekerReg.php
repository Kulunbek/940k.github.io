...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Регистрационная форма соискателя</a></span></h2>
                ...
                <form action="JobSeekerInsert.php" method="post" onSubmit="return validateForm(this,arrFormValidation);" enctype="multipart/form-data" id="form2">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <span class="textfieldRequiredMsg">Введите имя</span></span></td>
                    </tr>
                    ...
                    <tr>
					  ...
					  <span class="textfieldRequiredMsg">Введите квалификацию</span></td>
                    </tr>
                    <tr>
                      <td>Другое:</td>
                      <td><label>
                    ...
                    <tr>
                      ...
                      <span class="textfieldRequiredMsg">Введите дату рождения</span></span></td>
                    </tr>
                    <tr>
                      <td>Загрузить резюме:</td>
                      <td><label>
