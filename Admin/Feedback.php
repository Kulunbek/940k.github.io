                    ...
                    <table width="100%" border="1" bordercolor="#1CB5F1">
                        <tr>
                            ...
                            <th bgcolor="#1CB5F1" class="style3">
                                <div align="left" class="style9 style5"><strong>Имя соискателя</strong></div>
                            </th>
                            <th bgcolor="#1CB5F1" class="style3">
                                <div align="left" class="style9 style5"><strong>Отзыв</strong></div>
                            </th>
                            <th bgcolor="#1CB5F1" class="style3">
                                <div align="left" class="style12">Дата</div>
                            </th>
                        </tr>
                        <?php
