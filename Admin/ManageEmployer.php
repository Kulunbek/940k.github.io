                                ...
                                <table width="100%" border="1" bordercolor="#1CB5F1">
                                    <tr>
                                        ...
                                        <th bgcolor="#1CB5F1" class="style3">
                                            <div align="left" class="style9 style5"><strong>Наименование компании</strong></div>
                                        </th>
                                        <th bgcolor="#1CB5F1" class="style3">
                                            <div align="left" class="style9 style5"><strong>Город</strong></div>
                                        </th>
                                        <th bgcolor="#1CB5F1" class="style3">
                                            <div align="left" class="style12">Контактное лицо</div>
                                        </th>
                                        <th bgcolor="#1CB5F1" class="style3">
                                            <div align="left" class="style9 style5"><strong>Детали</strong></div>
                                        </th>
                                    </tr>
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td class="style3">
                                                <div align="left" class="style9 style5"><strong><a
                                                            href="DetailEmp.php?EmpId=<?php echo $Id; ?>">Детали</a></strong>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php
                                    ...
                                    <tr>
                                        <td colspan="4" class="style3">
                                            <div align="left"
                                                 class="style12"><?php echo "Всего " . $records . " записей"; ?> </div>
                                        </td>
                                    </tr>
                                    <?php
