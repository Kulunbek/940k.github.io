                                ...
                                <table width="100%" border="1" bordercolor="#1CB5F1">
                                    <tr>
                                        ...
                                        <th bgcolor="#1CB5F1" class="style3">
                                            <div align="left" class="style9 style5"><strong>Имя</strong>
                                            </div>
                                        </th>
                                        <th bgcolor="#1CB5F1" class="style3">
                                        ...
                                        <th bgcolor="#1CB5F1" class="style3">
                                            <div align="left" class="style12">Пол</div>
                                        </th>
                                        <th bgcolor="#1CB5F1" class="style3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="style3">
                                                <div align="left" class="style9 style5"><strong><a
                                                            href="DetailJob.php?JobId=<?php echo $Id; ?>">Детали</a></strong>
                                                </div>
                                            </td>
