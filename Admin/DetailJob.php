                        ...
                        <tr>
                            <td>
                                ...
                                <table width="100%" border="1" cellspacing="2" cellpadding="2">
                                    ...
                                    <tr>
                                        <td>Резюме:</td>
                                        <td><a href="../upload/<?php echo $row['Resume']; ?>" target="_blank">Просмотр</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><a href="ApprovJob.php?JobId=<?php echo $row['JobSeekId']; ?>">Утвердить соискателя</a></strong></td>
                                        <td></td>
                                    </tr>
                                </table>
                            </td>
