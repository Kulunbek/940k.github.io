            ...
            <div id="content">
                ...
                <div class="article">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td height="27" bgcolor="#A0B9F3"><span class="style4 style10">Создать новость</span></td>
                        </tr>
                        <tr>
                            <td height="26">
                                <form id="form1" method="post" action="InsertNews.php">
                                    <table width="100%" height="109" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td height="36"><span class="style9">Новость:</span></td>
                              ...
                              <span class="textfieldRequiredMsg">Поле обязательно для заполнения.</span></span></td>
                                        ...
                                        <tr>
                                            <td height="35"><span class="style9">Дата новости:</span></td>
                        ...
                        <tr>
                            <td height="25" bgcolor="#A0B9F3"><span class="style3">Список новостей</span></td>
                        </tr>
                        <tr>
                            <td>
                                <table width="100%" border="1" bordercolor="#1CB5F1">
                                    <tr>
                                        ...
                                        <th bgcolor="#1CB5F1">
                                            <div align="left" class="style11 style7 style8">Новость</div>
                                        </th>
                                        <th bgcolor="#1CB5F1">
                                            <div align="left" class="style11 style7 style8">Дата</div>
                                        </th>
                                        <th height="32" bgcolor="#1CB5F1">
                                            <div align="left" class="style11 style7 stylыe8">Редактировать</div>
                                        </th>
                                        <th bgcolor="#1CB5F1">
                                            <div align="left" class="style11 style7 style8">Удалить</div>
                                        </th>
                                    </tr>
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div align="left" class="style11 style7 style8"><a
                                                        href="EditNews.php?NewsId=<?php echo $Id; ?>">Редактировать</a></div>
                                            </td>
                                            <td>
                                                <div align="left" class="style11 style7 style8"><a
                                                        href="DeleteNews.php?NewsId=<?php echo $Id; ?>">Удалить</a></div>
                                            </td>
                                        </tr>
                                        <?php
                                    }
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div align="left"
                                                 class="style11 style7 style8"><?php echo "Всего " . $records . " записей"; ?> </div>
                                        </td>
                                    </tr>
                                    <?php
