            ...
            <div id="content">
                ...
                <div class="article">
                    ...
                    <table width="100%" height="209" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td height="33" bgcolor="#A0B9F3"><span class="style10 style11">Редактировать запись</span></td>
                        </tr>
                        <tr>
                            <td><?php
                                $Id = $_GET['UserId'];
                                ...
                                <form method="post" action="UpdateUser.php">
                                    <table width="100%" border="0">
                                        <tr>
                                            <td height="32"><span class="style8">Id пользователя</span></td>
                                ...
                                <span class="textfieldRequiredMsg">Поле обязательно для заполнения.</span></span></td>
                                        ...
                                        <tr>
                                            <td height="36"><span class="style8">Имя пользователя:</span></td>
                                ...
                                <span class="textfieldRequiredMsg">Поле обязательно для заполнения.</span></span></td>
                                        ...
                                        <tr>
                                            <td height="36"><span class="style8">Пароль:</span></td>
                                ...
                                <span class="textfieldRequiredMsg">Поле обязательно для заполнения.</span></span></td>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td><input type="submit" name="submit" value="Обновить"/></td>
                                        </tr>
                                    </table>
                                </form>
                                <?php
